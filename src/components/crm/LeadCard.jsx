...
import { 
  ...
  Trash2, Phone, Activity, ChevronDown, Bot 
} from 'lucide-react';
        ...
        <div className="group bg-white rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 flex flex-col overflow-visible relative border border-slate-200 hover:border-slate-300">
            ...
            <div className="absolute top-4 right-4 flex items-center gap-1.5 z-10">
                 <button 
                   ...
                   className="p-2 bg-white border border-slate-200 text-slate-400 hover:text-primary hover:border-primary/50 rounded-lg transition-all shadow-sm" 
                   title="Editar Lead"
                 >
                     <Edit3 size={14} />
                 </button>
                 <button 
                   ...
                   className="p-2 bg-white border border-slate-200 text-slate-400 hover:text-rose-500 hover:border-rose-200 rounded-lg transition-all shadow-sm" 
                   title="Eliminar/Blacklist"
                 >
                     <Trash2 size={14} />
                 </button>
            </div>
               ...
               <div className="p-6 space-y-5">
                   ...
                   {lead.dolor_detectado && (
                     <div className="bg-white p-4 rounded-lg border border-rose-100 shadow-sm relative overflow-hidden">
                        <span className="text-[10px] font-bold text-rose-500 tracking-wider uppercase mb-1 flex items-center gap-1.5">Diagnóstico</span>
                   ...
                   {['Respondió Apertura', 'Respondió Activador', 'Apertura Enviado', 'Activador Enviado', 'Reunión Agendada', 'No Interesado'].includes(lead.estado_contacto) && (
                      <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm relative group/ia overflow-hidden">
                         <div className="flex justify-between items-center mb-4">
                            ...
                            <button onClick={() => updateEstado(lead.id, 'Generar Sugerencia IA')} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-900 text-[10px] font-bold rounded-md transition-all">Analizar</button>
                         </div>
