...
export const STATUS_CONFIG = {
  idea:             { label: 'Ideación',      color: 'bg-cyan-500',      icon: <Sparkles size={14} /> },
  drafting:         { label: 'Guionización',    color: 'bg-violet-500',    icon: <Edit size={14} /> },
...
export const COLUMN_ORDER = ['idea', 'drafting', 'ready', 'recorded', 'published'];
